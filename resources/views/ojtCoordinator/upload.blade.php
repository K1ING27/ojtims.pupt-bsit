    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-body">
                <form id="uploadFileForm" action="{{url('/uploadfile')}}" method="post" enctype="multipart/form-data">
                    @csrf
                    <table>
            ...
            <div class="buttonsSection">
                ...
                <button type="submit" class="printBtn" id="submitBtn">Submit</button>
            </div>
        </div>
    </div>
</div>
        ...
        document.getElementById('submitBtn').addEventListener('click', function (event) {
            ...
            if (!allowedExtensions.exec(filePath)) {
                ...
                Swal.fire({
                    ...
                    text: 'Please upload a file with .doc or .docx extension.',
                });
