                        ...
                        <div class="modal-body" style="max-height: 400px; overflow-y: auto;">
                           <!-- Professor Creation Form -->
                            <form action="{{url('/professorCreate')}}" method="post" enctype="multipart/form-data">
                                ...
                                <div class="row mt-3">
                                    <div class="col-12 text-end" style="display: flex;  justify-content: flex-end ;">
                                    
                                    <button class="closeBtn" type="button" data-bs-dismiss="modal" style="margin-right: 10px;"> Close </button>
