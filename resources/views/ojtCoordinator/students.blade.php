                        ...
                        <tbody> 
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                            ...
                                            data-company-link="{{ $data['ojt']->companyLink }}" 
                                        ...
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <p style="color: maroon">Company Link: <span id="company-link"></span></p>
                                ...
                                $(document).ready(function () {
                                    ...
                                    $('#exModal').on('show.bs.modal', function (event) {
                                        ...
                                        modal.find('#company-link').text(button.data('company-link'));
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    Swal.fire(
                        ...
                        // Submit the form programmatically after the SweetAlert confirmation
                        document.getElementById('statusUpdateForm').submit();
                                ...
                                <td>        
                                                                ...
                                                                @csrf
                                                                    ...
                                                                    <button type="submit" class="btnNotify" style="border-radius: 12px;height:36px;">
                                                                    ...
                                                                    $(document).ready(function() {
                                                                        $('.btnNotify').click(function() {
                                                                            Swal.fire({
                                                                                ...
                                                                                text: 'Do you want to send a notification to the student?',
                                                                                icon: 'question',
                                                                                showCancelButton: true,
                                                                                confirmButtonColor: '#3085d6',
                                                                                cancelButtonColor: '#d33',
                                                                                ...
                                                                                if (result.isConfirmed) {
                                                                                    // Assuming you have a function to send the notification
                                                                    ...
                                                                    function sendNotificationToStudent() {
                                                                        ...
                                                                        setTimeout(() => {
                                                                            Swal.fire({
                                                                                ...
                                                                                text: 'The student has been notified successfully.',
                                                                                icon: 'success',
