                            ...
                            <form action="{{url('/companyCreate')}}" method="post" enctype="multipart/form-data">
                                ...
                                <table>
                                    ...
                                    <div class="form-group" style="font-size: 22px;">
                                        ...
                                        <label class="form-label" for="companyLink">Company links: (Optional)</label>
                                        <input class="form-input" type="text" name="companyLink">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <div class="tooltip">
                                            <button class="btnRemove" style="margin-left: 10%;" data-company-id="{{ $company->id }}">
                                    ...
                                    <script>
                                        ...
                                        function showRemoveConfirmation(companyId) {
                                            Swal.fire({
                                                title: 'Are you sure?',
                                                text: 'You are about to remove this company.',
                                                icon: 'warning',
                                        ...
                                        // Function to remove company via AJAX
                                        function removeCompany(companyId) {
                                            $.ajax({
                                                type: 'POST',
                                                url: '/remove/company/' + companyId, // Adjust URL as per your Laravel route setup
                                                data: {
                                                    _token: "{{ csrf_token() }}"
                                                },
                                                success: function(data) {
                                                    console.log('Removal successful:', data); // Debugging log
                                                    Swal.fire(
                                                        'Removed!',
                                                ...
                                                error: function(xhr, status, error) {
                                                    console.error('An error occurred:', status, error); // Debugging log
                                                    Swal.fire(
                                                        'Error!',
                                                        'An error occurred while trying to remove the company.',
                                                        'error'
                                                    );
                                                }
                                            });
                                        ...
                                        $(document).ready(function() {
                                            $('.btnRemove').click(function(event) {
                                                ...
                                                // Get the company ID associated with the button
                                                var companyId = $(this).data('company-id');
                                                // Call the showRemoveConfirmation function
                                                showRemoveConfirmation(companyId);
                                            });
                                        });
                                    </script>
