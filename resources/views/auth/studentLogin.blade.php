...
<body>
                    ...
                    <div class="row">
                        {{-- <div > --}}
                            ...
                            <div class="card2">
                                ...
                                <form action="{{route('student-user')}}" method="post" class="mt-4">

                                    @if(Session::has('success'))
                                    <div class="alert alert-success alert-custom" id="success-alert">{{Session::get('success')}}</div>
                                    @endif
                                    @if(Session::has('fail'))
                                    ...
                                    <a href="/forgot-student">Forgot Password?</a>
                                    <br>
                                    <a href="{{ route('auth.registration') }}">Student? Don't have an account?</a>
                                </form>
                            </div>
                        {{-- </div> --}}
                    </div>
    ...
    <script>
        ...
        setTimeout(function() {
            ...
            var sucAlert = document.getElementById('success-alert');
            if (sucAlert) {
