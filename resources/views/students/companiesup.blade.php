            ...
            <div class="navigation">
                <ul>
                    ...
                    <li>
                        ...
                        <li >
                            <a href="{{ url('/student/pending') }}">
                                <span class="titlesub" style="font-size: 12px;">Pending MOA</span>
                            </a>
                        </li>

                        <li class="active" >
                            <a href="{{ url('/student/MOA') }}">
                                <span class="titlesub" style="font-size: 12px;">Notarized MOA</span>
                            </a>
                        </li>
                            ...
                            <form action="{{url('/companyCreate')}}" method="post" enctype="multipart/form-data">
                                ...
                                <table>
                                    ...
                                    <label class="form-label" for="company_name">Company Name*:</label>
                                        ...
                                        <label class="form-label" for="companyLink">Company Link*: (Optional)</label>
                                        <input class="form-input" type="text" name="companyLink">
                                        <div class="error-message" id="companyLink-error">Please enter the company link.</div>
